...
###  HELLO
#################
set(CONAN_HELLO_ROOT "/home/julianmr/.conan/data/hello/1.1.0/mine/mine/package/0db3c9ab8431419beae3934b1a0cb087b700e965")
set(CONAN_INCLUDE_DIRS_HELLO )
set(CONAN_LIB_DIRS_HELLO )
set(CONAN_BIN_DIRS_HELLO )
set(CONAN_RES_DIRS_HELLO )
set(CONAN_SRC_DIRS_HELLO )
set(CONAN_BUILD_DIRS_HELLO "/home/julianmr/.conan/data/hello/1.1.0/mine/mine/package/0db3c9ab8431419beae3934b1a0cb087b700e965/")
set(CONAN_FRAMEWORK_DIRS_HELLO )
set(CONAN_LIBS_HELLO hello)
set(CONAN_PKG_LIBS_HELLO hello)
set(CONAN_SYSTEM_LIBS_HELLO )
set(CONAN_FRAMEWORKS_HELLO )
set(CONAN_FRAMEWORKS_FOUND_HELLO "")  # Will be filled later
set(CONAN_DEFINES_HELLO )
set(CONAN_BUILD_MODULES_PATHS_HELLO )
# COMPILE_DEFINITIONS are equal to CONAN_DEFINES without -D, for targets
set(CONAN_COMPILE_DEFINITIONS_HELLO )

set(CONAN_C_FLAGS_HELLO "")
set(CONAN_CXX_FLAGS_HELLO "")
set(CONAN_SHARED_LINKER_FLAGS_HELLO "")
set(CONAN_EXE_LINKER_FLAGS_HELLO "")

# For modern cmake targets we use the list variables (separated with ;)
set(CONAN_C_FLAGS_HELLO_LIST "")
set(CONAN_CXX_FLAGS_HELLO_LIST "")
set(CONAN_SHARED_LINKER_FLAGS_HELLO_LIST "")
set(CONAN_EXE_LINKER_FLAGS_HELLO_LIST "")

# Apple Frameworks
conan_find_apple_frameworks(CONAN_FRAMEWORKS_FOUND_HELLO "${CONAN_FRAMEWORKS_HELLO}" "_HELLO" "")
# Append to aggregated values variable
set(CONAN_LIBS_HELLO ${CONAN_PKG_LIBS_HELLO} ${CONAN_SYSTEM_LIBS_HELLO} ${CONAN_FRAMEWORKS_FOUND_HELLO})
...
set(CONAN_DEPENDENCIES hello openssl)
...
set(CONAN_LIBS hello ssl crypto ${CONAN_LIBS})
set(CONAN_PKG_LIBS hello ssl crypto ${CONAN_PKG_LIBS})
set(CONAN_SYSTEM_LIBS dl pthread rt ${CONAN_SYSTEM_LIBS})
set(CONAN_FRAMEWORKS  ${CONAN_FRAMEWORKS})
set(CONAN_FRAMEWORKS_FOUND "")  # Will be filled later
set(CONAN_DEFINES  ${CONAN_DEFINES})
set(CONAN_BUILD_MODULES_PATHS  ${CONAN_BUILD_MODULES_PATHS})
set(CONAN_CMAKE_MODULE_PATH "/home/julianmr/.conan/data/hello/1.1.0/mine/mine/package/0db3c9ab8431419beae3934b1a0cb087b700e965/" ${CONAN_CMAKE_MODULE_PATH})
...
macro(conan_define_targets)
    ...
    set(_CONAN_PKG_LIBS_HELLO_DEPENDENCIES "${CONAN_SYSTEM_LIBS_HELLO} ${CONAN_FRAMEWORKS_FOUND_HELLO} CONAN_PKG::openssl")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_HELLO_DEPENDENCIES "${_CONAN_PKG_LIBS_HELLO_DEPENDENCIES}")
    conan_package_library_targets("${CONAN_PKG_LIBS_HELLO}" "${CONAN_LIB_DIRS_HELLO}"
                                  CONAN_PACKAGE_TARGETS_HELLO "${_CONAN_PKG_LIBS_HELLO_DEPENDENCIES}"
                                  "" hello)
    set(_CONAN_PKG_LIBS_HELLO_DEPENDENCIES_DEBUG "${CONAN_SYSTEM_LIBS_HELLO_DEBUG} ${CONAN_FRAMEWORKS_FOUND_HELLO_DEBUG} CONAN_PKG::openssl")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_HELLO_DEPENDENCIES_DEBUG "${_CONAN_PKG_LIBS_HELLO_DEPENDENCIES_DEBUG}")
    conan_package_library_targets("${CONAN_PKG_LIBS_HELLO_DEBUG}" "${CONAN_LIB_DIRS_HELLO_DEBUG}"
                                  CONAN_PACKAGE_TARGETS_HELLO_DEBUG "${_CONAN_PKG_LIBS_HELLO_DEPENDENCIES_DEBUG}"
                                  "debug" hello)
    set(_CONAN_PKG_LIBS_HELLO_DEPENDENCIES_RELEASE "${CONAN_SYSTEM_LIBS_HELLO_RELEASE} ${CONAN_FRAMEWORKS_FOUND_HELLO_RELEASE} CONAN_PKG::openssl")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_HELLO_DEPENDENCIES_RELEASE "${_CONAN_PKG_LIBS_HELLO_DEPENDENCIES_RELEASE}")
    conan_package_library_targets("${CONAN_PKG_LIBS_HELLO_RELEASE}" "${CONAN_LIB_DIRS_HELLO_RELEASE}"
                                  CONAN_PACKAGE_TARGETS_HELLO_RELEASE "${_CONAN_PKG_LIBS_HELLO_DEPENDENCIES_RELEASE}"
                                  "release" hello)
    set(_CONAN_PKG_LIBS_HELLO_DEPENDENCIES_RELWITHDEBINFO "${CONAN_SYSTEM_LIBS_HELLO_RELWITHDEBINFO} ${CONAN_FRAMEWORKS_FOUND_HELLO_RELWITHDEBINFO} CONAN_PKG::openssl")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_HELLO_DEPENDENCIES_RELWITHDEBINFO "${_CONAN_PKG_LIBS_HELLO_DEPENDENCIES_RELWITHDEBINFO}")
    conan_package_library_targets("${CONAN_PKG_LIBS_HELLO_RELWITHDEBINFO}" "${CONAN_LIB_DIRS_HELLO_RELWITHDEBINFO}"
                                  CONAN_PACKAGE_TARGETS_HELLO_RELWITHDEBINFO "${_CONAN_PKG_LIBS_HELLO_DEPENDENCIES_RELWITHDEBINFO}"
                                  "relwithdebinfo" hello)
    set(_CONAN_PKG_LIBS_HELLO_DEPENDENCIES_MINSIZEREL "${CONAN_SYSTEM_LIBS_HELLO_MINSIZEREL} ${CONAN_FRAMEWORKS_FOUND_HELLO_MINSIZEREL} CONAN_PKG::openssl")
    string(REPLACE " " ";" _CONAN_PKG_LIBS_HELLO_DEPENDENCIES_MINSIZEREL "${_CONAN_PKG_LIBS_HELLO_DEPENDENCIES_MINSIZEREL}")
    conan_package_library_targets("${CONAN_PKG_LIBS_HELLO_MINSIZEREL}" "${CONAN_LIB_DIRS_HELLO_MINSIZEREL}"
                                  CONAN_PACKAGE_TARGETS_HELLO_MINSIZEREL "${_CONAN_PKG_LIBS_HELLO_DEPENDENCIES_MINSIZEREL}"
                                  "minsizerel" hello)

    add_library(CONAN_PKG::hello INTERFACE IMPORTED)

    # Property INTERFACE_LINK_FLAGS do not work, necessary to add to INTERFACE_LINK_LIBRARIES
    set_property(TARGET CONAN_PKG::hello PROPERTY INTERFACE_LINK_LIBRARIES ${CONAN_PACKAGE_TARGETS_HELLO} ${_CONAN_PKG_LIBS_HELLO_DEPENDENCIES}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_HELLO_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_HELLO_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_HELLO_LIST}>

                                                                 $<$<CONFIG:Release>:${CONAN_PACKAGE_TARGETS_HELLO_RELEASE} ${_CONAN_PKG_LIBS_HELLO_DEPENDENCIES_RELEASE}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_HELLO_RELEASE_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_HELLO_RELEASE_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_HELLO_RELEASE_LIST}>>

                                                                 $<$<CONFIG:RelWithDebInfo>:${CONAN_PACKAGE_TARGETS_HELLO_RELWITHDEBINFO} ${_CONAN_PKG_LIBS_HELLO_DEPENDENCIES_RELWITHDEBINFO}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_HELLO_RELWITHDEBINFO_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_HELLO_RELWITHDEBINFO_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_HELLO_RELWITHDEBINFO_LIST}>>

                                                                 $<$<CONFIG:MinSizeRel>:${CONAN_PACKAGE_TARGETS_HELLO_MINSIZEREL} ${_CONAN_PKG_LIBS_HELLO_DEPENDENCIES_MINSIZEREL}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_HELLO_MINSIZEREL_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_HELLO_MINSIZEREL_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_HELLO_MINSIZEREL_LIST}>>

                                                                 $<$<CONFIG:Debug>:${CONAN_PACKAGE_TARGETS_HELLO_DEBUG} ${_CONAN_PKG_LIBS_HELLO_DEPENDENCIES_DEBUG}
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_HELLO_DEBUG_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,MODULE_LIBRARY>:${CONAN_SHARED_LINKER_FLAGS_HELLO_DEBUG_LIST}>
                                                                 $<$<STREQUAL:$<TARGET_PROPERTY:TYPE>,EXECUTABLE>:${CONAN_EXE_LINKER_FLAGS_HELLO_DEBUG_LIST}>>)
    set_property(TARGET CONAN_PKG::hello PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${CONAN_INCLUDE_DIRS_HELLO}
                                                                      $<$<CONFIG:Release>:${CONAN_INCLUDE_DIRS_HELLO_RELEASE}>
                                                                      $<$<CONFIG:RelWithDebInfo>:${CONAN_INCLUDE_DIRS_HELLO_RELWITHDEBINFO}>
                                                                      $<$<CONFIG:MinSizeRel>:${CONAN_INCLUDE_DIRS_HELLO_MINSIZEREL}>
                                                                      $<$<CONFIG:Debug>:${CONAN_INCLUDE_DIRS_HELLO_DEBUG}>)
    set_property(TARGET CONAN_PKG::hello PROPERTY INTERFACE_COMPILE_DEFINITIONS ${CONAN_COMPILE_DEFINITIONS_HELLO}
                                                                      $<$<CONFIG:Release>:${CONAN_COMPILE_DEFINITIONS_HELLO_RELEASE}>
                                                                      $<$<CONFIG:RelWithDebInfo>:${CONAN_COMPILE_DEFINITIONS_HELLO_RELWITHDEBINFO}>
                                                                      $<$<CONFIG:MinSizeRel>:${CONAN_COMPILE_DEFINITIONS_HELLO_MINSIZEREL}>
                                                                      $<$<CONFIG:Debug>:${CONAN_COMPILE_DEFINITIONS_HELLO_DEBUG}>)
    set_property(TARGET CONAN_PKG::hello PROPERTY INTERFACE_COMPILE_OPTIONS ${CONAN_C_FLAGS_HELLO_LIST} ${CONAN_CXX_FLAGS_HELLO_LIST}
                                                                  $<$<CONFIG:Release>:${CONAN_C_FLAGS_HELLO_RELEASE_LIST} ${CONAN_CXX_FLAGS_HELLO_RELEASE_LIST}>
                                                                  $<$<CONFIG:RelWithDebInfo>:${CONAN_C_FLAGS_HELLO_RELWITHDEBINFO_LIST} ${CONAN_CXX_FLAGS_HELLO_RELWITHDEBINFO_LIST}>
                                                                  $<$<CONFIG:MinSizeRel>:${CONAN_C_FLAGS_HELLO_MINSIZEREL_LIST} ${CONAN_CXX_FLAGS_HELLO_MINSIZEREL_LIST}>
                                                                  $<$<CONFIG:Debug>:${CONAN_C_FLAGS_HELLO_DEBUG_LIST}  ${CONAN_CXX_FLAGS_HELLO_DEBUG_LIST}>)
    ...
    set(CONAN_TARGETS CONAN_PKG::hello CONAN_PKG::openssl)
